/*
 * xbabka01 xbobci00
 * blok ktory zisti zvysok po deleni int vstupu a da ich na vystup
 */
...
public class ItemIntegerModulo extends AbstractItem {
    public static final String Description =
            "x % y = [int]\n    porty:\n          [x -> int]\n          [y -> int]";

    public ItemIntegerModulo() {
        super("x % y");
    ...
    public String getDescription() {
        return ItemIntegerModulo.Description;
    }
    ...
    public void Execute() throws Exception {
        ...
        double result = NaN;
        if (!Double.isNaN(val0) && !Double.isNaN(val1) && val1 != 0) {
            result = val0 % val1;
        }
