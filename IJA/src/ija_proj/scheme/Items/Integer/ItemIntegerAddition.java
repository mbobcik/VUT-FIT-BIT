/*
 * xbabka01 xbobci00
 * blok ktory spocita int vstupy z portou a da ich na vystup
 */
...
public class ItemIntegerAddition extends AbstractItem {

    public static final String Description =
            "x + y = [int]\n    porty:\n          [x -> int]\n          [y -> int]";

    public ItemIntegerAddition() {
        super("x + y");
    ...
    public String getDescription() {
        return ItemIntegerAddition.Description;
    }
