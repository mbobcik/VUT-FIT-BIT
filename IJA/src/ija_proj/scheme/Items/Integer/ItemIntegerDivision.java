/*
 * xbabka01 xbobci00
 * blok ktory vydeli int vstupy z portou a da ich na vystup
 */
...
public class ItemIntegerDivision extends AbstractItem {
    public static final String Description =
            "x / y = [int]\n    porty:\n          [x -> int]\n          [y -> int]";

    public ItemIntegerDivision() {
        super("x / y");
    ...
    public String getDescription() {
        return ItemIntegerDivision.Description;
    }
