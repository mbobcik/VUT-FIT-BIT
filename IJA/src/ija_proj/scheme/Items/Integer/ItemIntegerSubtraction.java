/*
 * xbabka01 xbobci00
 * blok ktory odcita int vstupy a da vysledok na vystup
 */
...
public class ItemIntegerSubtraction extends AbstractItem {
    public static final String Description =
            "x - y = [int]\n    porty:\n          [x -> int]\n          [y -> int]";

    public ItemIntegerSubtraction() {
        super("x - y");
    ...
    public String getDescription() {
        return ItemIntegerSubtraction.Description;
    }
