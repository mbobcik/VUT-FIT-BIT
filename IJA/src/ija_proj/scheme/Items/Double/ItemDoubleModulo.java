/*
 * xbabka01 xbobci00
 * blok ktory zisti zvysok po deleny vstupy a da ich na vystup
 */
...
public class ItemDoubleModulo extends AbstractItem {
    public static final String Description =
            "x % y = [double]\n    porty:\n          [x -> double]\n          [y -> double]";

    public ItemDoubleModulo() {
        super("x % y");
    ...
    public String getDescription() {
        return ItemDoubleModulo.Description;
    }
