/*
 * xbabka01 xbobci00
 * blok ktory vynasobi vstupy z portou a da ich na vystup
 */
...
public class ItemDoubleDivision extends AbstractItem {
    public static final String Description =
            "x / y = [double]\n    porty:\n          [x -> double]\n          [y -> double]";

    public ItemDoubleDivision() {
        super("x / y");
    ...
    public String getDescription() {
        return ItemDoubleDivision.Description;
    }
