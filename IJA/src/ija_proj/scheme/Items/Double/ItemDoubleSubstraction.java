/*
 * xbabka01 xbobci00
 * blok ktory odcita vstupy a da vysledok na vystup
 */
...
public class ItemDoubleSubstraction extends AbstractItem {
    public static final String Description =
            "x - y = [double]\n    porty:\n          [x -> double]\n          [y -> double]";

    public ItemDoubleSubstraction() {
        super("x - y");
    ...
    public String getDescription() {
        return ItemDoubleSubstraction.Description;
    }
