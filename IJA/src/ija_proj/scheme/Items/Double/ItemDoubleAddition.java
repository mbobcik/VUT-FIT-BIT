/*
 * xbabka01 xbobci00
 * blok ktory spocita vstupy z portou a da ich na vystup
 */
...
public class ItemDoubleAddition extends AbstractItem {

    public static final String Description =
            "x + y = [double]\n    porty:\n          [x -> double]\n          [y -> double]";

    public ItemDoubleAddition() {
        super("x + y");
    ...
    public String getDescription() {
        return ItemDoubleAddition.Description;
    }
